...
import com.kks.customfont_ex.databinding.ActivityMainBinding
...
class MainActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        this.onBackPressedDispatcher.addCallback(this, backPressedCallback.callback)
        ...
        binding.newSentenceButton.setOnClickListener {
            binding.mainSentence.text = sentenceList.random()
        }
